...
export const BLOG_POSTS: BlogPost[] = [
  {
    ...
    readTime: "5 min read",
    category: "Case Study",
    imageGradient: "from-cyan-500/20 to-cyan-600/10",
