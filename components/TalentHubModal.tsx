...
export const TalentHubModal: React.FC<TalentHubModalProps> = ({ hub, onClose }) => {
  ...
  return (
    ...
    >
      ...
      <motion.div 
        className="relative w-full h-screen supports-[height:100dvh]:h-[100dvh] sm:h-auto sm:supports-[height:100dvh]:h-auto sm:max-h-[90vh] sm:max-w-5xl overflow-y-auto bg-background border-0 sm:border sm:border-border rounded-none sm:rounded-[2.5rem] shadow-2xl shadow-cyan-900/20 scrollbar-hide"
