...
interface EnhancedVideoHeroProps {
  videoUrl?: string;
  posterUrl?: string;
  title?: string;
  subtitle?: string;
...
export const EnhancedVideoHero: React.FC<EnhancedVideoHeroProps> = ({
  videoUrl,
  posterUrl,
      ...
      <AnimatePresence>
        {videoUrl && (
          ...
          >
            <motion.button
              onClick={togglePlay}
              className="p-3 rounded-lg bg-cyan-500/20 hover:bg-cyan-500/40 text-cyan-400 transition-colors backdrop-blur"
...
export default EnhancedVideoHero;
